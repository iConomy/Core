...
import com.iCo6.listeners.MoneyTransactionListener;
...
public class iConomy extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            if(!(type.equals(Type.InventoryDB) || type.equals(Type.MiniDB))) {
                ...
                if(driver != null)
                    if(!(new File("lib", driver.getFilename()).exists())) {
                        System.out.println("[iCo6] Downloading " + driver.getFilename() + "...");
                        wget.fetch(driver.getUrl(), driver.getFilename());
                        System.out.println("[iCo6] Finished Downloading.");
                    }
            }

            // Setup Commands
            Commands.add("/money +name", new Money(this));
            Commands.setPermission("money", "iCo6.holdings");
            Commands.setPermission("money+", "iCo6.holdings.others");
                    ...
                    if(!Database.tableExists(Constants.Nodes.DatabaseTable.toString())) {
                        ...
                        try {
                            ...
                            try{
                                ...
                                System.out.println("[iCo6] Error creating database: " + ex);
                            } finally {
                                DbUtils.close(c);
                            }
                        } catch (SQLException ex) {
                            System.out.println("[iCo6] Database Error: " + ex);
                        }
                    }
                } else {
                    this.onConversion();
            ...
            getServer().getPluginManager().registerEvents(new MoneyTransactionListener(this), this);
        } finally {
            ...
            public void run() {
                ...
                try {
                    try{
                        ...
                        System.out.println("[iCo6] Error issueing SQL query: " + ex);
                    } finally {
                        DbUtils.close(old);
                    }
                } catch (SQLException ex) {
                ...
                System.out.println("[iCo6] Conversion complete. Please update your configuration, change convert to false!");
            }
        });
    ...
    public boolean hasPermissions(CommandSender sender, String command) {
        if(sender instanceof Player) {
            ...
            if(player == null) {
                System.out.println("[iCo6] Cannot execute command with false player");
                return false;
            }
    ...
    /*
     * Formats the holding balance in a human readable form with the currency attached:
     * 20000.53 = 20,000.53 Coin
    ...
    /*
     * Formats the money in a human readable form with the currency attached:
     * 20000.53 = 20,000.53 Coin
     * 20000.00 = 20,000 Coin
     *
     * @param amount double
